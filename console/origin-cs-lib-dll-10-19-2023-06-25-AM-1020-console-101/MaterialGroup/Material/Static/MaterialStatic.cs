...
namespace Core
{
    ...
    internal partial class Material
    {
        ...
        public static void Manual(MaterialStringSplitcharacter HeaderSplitcharacter__VALUE, String BodySubstring__VALUE, out MaterialModule MaterialModule__VALUE)
        {
            ...
            MaterialreflectPrimarymodule materialreflectModule;

            Materialreflect.Manual(FooterSubstringFormat___VALUE, material.EscapeCharacterArray, out materialreflectModule);

            //Scope.AddMaterial(materialreflectModule.HundredthIII.Function.Materialchain);
