...
namespace Core
{
    ...
    internal partial class MaterialreflectSequence
    {
        ...
        internal MaterialreflectSequence(MaterialStringFormat StringFormat__VALUE, Char[] EscapeCharacter__ARRAY, Boolean answer_DEBUG_is)
        {
            ...
            reflect = new Materialreflect(InputStringSafe___VALUE, EscapeCharacterArraySafe____VALUE, answer_DEBUG_is);
