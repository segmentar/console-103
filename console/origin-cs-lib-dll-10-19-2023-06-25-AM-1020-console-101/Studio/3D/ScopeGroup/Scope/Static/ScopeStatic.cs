...
namespace Core
{
    ...
    public partial class Scope
    {
        ...
        public static void Procedure(Boolean MaterialHas_ANSWER, Boolean MaterialreflectHas_ANSWER)
        {
            if (MaterialHas_ANSWER is true)
            {
                Material.Procedure();
            }
            else
            ...
            if (MaterialreflectHas_ANSWER is true)
            {
        ...
        public static void Manual(Boolean answer_HOST_is)
        {
            if (answer_HOST_is is true)
            {
                Host.Manual();
            }
            else
