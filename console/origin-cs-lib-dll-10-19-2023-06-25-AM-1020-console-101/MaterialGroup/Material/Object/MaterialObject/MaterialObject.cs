    ...
    internal partial class Material
    {
        ...
        public override String ToString()
        {
            return String.Join('\n'.ToString(), new String[] {
                ...
                String.Empty + '\t' + '~' + "02" + ' ' + nameof(HeaderSplitcharacterSubstring) + ':' + ' ' + "<hidden>",
                String.Empty + '\t' + '~' + "03" + ' ' + nameof(HeaderSplitcharacterSubstring) + ':' + ' ' + $"<safe><<{HeaderSplitcharacterSubstring.StringValue}>>",
