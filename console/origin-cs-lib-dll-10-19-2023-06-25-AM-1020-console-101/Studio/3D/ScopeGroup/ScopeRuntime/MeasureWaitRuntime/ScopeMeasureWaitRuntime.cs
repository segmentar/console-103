...
namespace Core
{
    ...
    public partial class Scope
    {
        public static void MeasureWaitRuntime()
        {
            ...
            MeasureWait.MaterialchainArrayList = new ArrayList();

            MeasureWait.ValidateMaterialchain = new Dictionary<Materialchain, Boolean>();

            MeasureWait.ValidateMaterialquery = new Dictionary<Materialquery, Boolean>();
