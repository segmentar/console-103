...
namespace Core
{
    ...
    public partial class Interop
    {
        ...
        {
            if (ArchitectureConsoleLJOneFirst.ArgumentList.Contains("display-argument") is false)
            {
                return;
            }
            else
            ...
            var join = String.Join(comma.ToString(), ArchitectureConsoleLJOneFirst.ArgumentList.ToArray());
